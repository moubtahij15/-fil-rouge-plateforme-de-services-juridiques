<template lang="">
       ...
       <div class="relative z-10 w-full max-w-2xl lg:mt-0 lg:w-5/12"> 
            <form  name = "form" @submit="register" >
                <div class="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
                       

                            <div  v-if ="message" class="flex w-full max-w-sm mx-auto overflow-hidden bg-white1 rounded-lg shadow-md dark:bg-gray-800">
                        <div class="flex items-center justify-center w-12 bg-red">
                        <svg class="w-6 h-6 text-white1 fill-current" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mx-3">
                <span class="font-semibold text-red dark:text-red">Erreur</span>
                <p class="text-sm text-gray-600 dark:text-gray-200">{{this.message}}</p>
            </div>
        </div>
    </div> 
                       
                    <h4 class="w-full font-serif text-4xl font-medium leading-snug">Inscription</h4>
                    
                    <p class="text-md  mx-auto mt-3  text-center"> Déja inscrit ?  <a  @click="redirectTo({ val: 'signIn' })" class="text-blue cursor-pointer underline">Connectez-vous</a></p>
                    <div class="relative w-full mt-6 space-y-8">
                       
                       
                       <div class="relative">
                            <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Nom</label>
                            <input  v-model="user.nom" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="Nom" required>
                      
                      </div>
                       <div class="relative">
                            <label  class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Prenom</label>
                            <input v-model="user.prenom" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="Prenom" required>
                      
                      </div>
                       <div class="relative">
                            <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Email</label>
                            <input  v-model="user.email" type="text" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="******@example.com" required>
                        ...
                        <!-- <option>{{ this.categEdit }}</option> -->
                            ...
                            <select  v-model="this.user.ville_id" required class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" >
                        ...
                        <div class="relative">
                            ...
                            <input v-model="user.tel" type="number" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="tel" required>
                        </div>
                        <div class="relative">
                            <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">password</label>
                            <input  v-model="user.password" type="password" class="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="password" required>
                        </div>
                        <div class="relative">
                            <button type="submit" class="inline-block w-full px-5 py-4 text-xl font-medium text-center text-primary transition duration-200 bg-yellow-300 rounded-lg hover:bg-gray ease">Submit</button>
