...
<div class=" w-full mx-auto my-4 border-b-2 pb-4">	
	<div class="flex pb-3 mx-auto   w-full">
		...
		<div class="flex-1">
			<div   :class = "(step1)?'bg-primary text-white ':'bg-white'"
        ...
        >
			<div class="w-full bg-primary rounded items-center align-middle align-center flex-1">
			 	<div class="bg-primary text-xs leading-none py-1 text-center text-primary rounded " ></div>
			</div>
		</div>


		<div class="flex-1">
			<div :class = "(step2)?'bg-primary text-white ':'bg-white'"
            class="w-10 h-10  border-grey-light mx-auto rounded-full text-lg  flex items-center">
		...
		<div class="flex-1">
			<div  :class = "(step3)?'bg-primary text-white ':'bg-white'"
            class="w-10 h-10   border-grey-light mx-auto rounded-full text-lg  flex items-center">
	...
	<div  v-if="step1" class="max-w-xl mt-5  md:mx-auto sm:text-center lg:max-w-xl ">
        ...
        <div class="-my-2 py-2 overflow-x-auto  mx-auto max-w-xl mb-10 sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
      ...
      />
                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                    <table class="mx-auto">
                        <thead>
                            <tr>
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-center leading-4 text-blue-500 tracking-wider">heure</th>
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider"></th>
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider"></th>
                               
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-center text-sm leading-4 text-blue-500 tracking-wider"> choisi</th>
                            </tr>
                        </thead>
                               ...
                               <tr  v-for="elem in $store.state.creneaux" :key="elem.id">
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                        <div class="flex items-center">
                                            <div>
                                                <div class="text-sm leading-5 text-gray-800">{{elem.heure_debut}}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td></td>
                                    ...
                                    <td class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">
                                        <button class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-primary hover:text-white focus:outline-none" @click="dateValidate(elem)">choisie</button>
                                    </td>
                          </tr>
                        </tbody>
                    </table>
            ...
            <!-- step2 -->
            	<div   v-if="step2" class="max-w-xl mt-5  md:mx-auto sm:text-center lg:max-w-xl ">
                <h2
                    class="max-w-lg mb-6 font-sans text-3xl font-medium leading-none tracking-tight text-gray-900 sm:text-3xl md:mx-auto">
           Entrer votre Sujet :                
...
<!-- step3 -->
<div  v-if="step3" class="max-w-xl mt-5  md:mx-auto sm:text-center lg:max-w-xl ">
