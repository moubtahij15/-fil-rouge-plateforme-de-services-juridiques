                ...
                <div class="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
                    ...
                    <div class="relative w-full mt-6 space-y-8">
                       ...
                       <div class="relative">
                        ...
                        <div class="relative">
                            <a href="#_" class="inline-block w-full px-5 py-4 text-xl font-medium text-center text-primary transition duration-200 bg-yellow-300 rounded-lg hover:bg-gray ease">Valider</a>
